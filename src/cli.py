...
def main():
    try:
        ...
        parser.add_argument(
            "-s", "--save", default=True, type=bool, help="Save commit embeddings"
        )
        ...
        parser.add_argument("query", help="The string to compare with")
        parser.add_argument(
            "git_args",
        ...
        for commit in commits:
            commit_embedding = embed_commit(model, commit, args.save, save_path)
